...
- 在 `IntelliJ IDEA` 开发环境中，新建一个 `File and Code Template`，让所有新建的 Java 文件自动包含以下 SPDX 头：

``` text
// SPDX-License-Identifier: MIT
// Copyright (c) 2024 Huawei Technologies Co., Ltd.
// Copyright (c) 2024-${YEAR} The FIT Lab AI Group
```

- 修改已有文件时不要删除原有的 Huawei 版权声明（MIT 协议要求保留），仅在需要时更新 `The FIT Lab AI Group` 一行的年份范围。
