...
```
[yyyy-MM-dd hh:mm:ss.SSS] [INFO ] [main] [org.fitframework.runtime.aggregated.AggregatedFitRuntime] Prepare to start FIT application...
[yyyy-MM-dd hh:mm:ss.SSS] [INFO ] [main] [org.fitframework.runtime.aggregated.AggregatedFitRuntime] FIT application started.
