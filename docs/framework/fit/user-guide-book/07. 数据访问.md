...
<mapper namespace="org.fitframework.jade.mapper.UserMapper">
    <select id="getUserById" resultType="org.fitframework.jade.dto.UserDo">
        SELECT *
        FROM users
        WHERE id = #{id}
    </select>

    <insert id="insertUser" parameterType="org.fitframework.jade.dto.UserDo">
