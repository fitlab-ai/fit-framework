...
package org.fitframework.waterflow;

/**
 * 异常类型枚举类。
 * Generic Exception: 10000000-10000999.
...
public enum ErrorCodes {
    ...
    /**
     * 流程执行过程通过 ohscript 调用 fitable 出现异常。
     */
    ...
    /**
     * Retrieves the error code associated with this instance.
     * The error code typically represents a specific error condition or status.
     *
    ...
    /**
     * Retrieves the descriptive message associated with this instance.
     * The message typically provides human-readable details about the status or error condition.
     *
     * @return the descriptive message text.
     */
