...
package org.fitframework.build;

import static org.assertj.core.api.Assertions.assertThat;

import org.fitframework.build.service.ErrorManifest;
...
class ErrorManifestTest {
    ...
    void shouldWriteErrorMetadata() throws IOException, MojoExecutionException {
        ...
        ErrorManifest file =
                new ErrorManifest(MapBuilder.<String, Integer>get().put("com.example.SampleException", 1).build());
