...
class ConsoleLoggerTest {
    ...
    @Nested
    @DisplayName("当把 'org.fitframework.log' 包下的所有日志级别调整为错误级别之后")
    class AfterSetParentLevelsToError {
        @BeforeEach
        void setup() {
            Loggers.getFactory().setLevels("org.fitframework.log", Logger.Level.ERROR);
        }
    ...
    @Nested
    @DisplayName("当把 'org.fitframework.log.console' 包下的所有日志级别调整为错误级别之后")
    class AfterSetCurrentLevelsToError {
        @BeforeEach
        void setup() {
            Loggers.getFactory().setLevels("org.fitframework.log.console", Logger.Level.ERROR);
        }
    ...
    @Nested
    @DisplayName("当把 'org.fitframework.log.console.sample' 包下的所有日志级别调整为错误级别之后")
    class AfterSetChildLevelsToError {
        @BeforeEach
        void setup() {
            Loggers.getFactory().setLevels("org.fitframework.log.console.sample", Logger.Level.ERROR);
        }
