...
public class DefaultTestClassResolver implements TestClassResolver {
    private static final Set<String> DEFAULT_SCAN_PACKAGES = new HashSet<>(Arrays.asList("org.fitframework.value",
            "org.fitframework.serialization",
            "org.fitframework.validation"));
