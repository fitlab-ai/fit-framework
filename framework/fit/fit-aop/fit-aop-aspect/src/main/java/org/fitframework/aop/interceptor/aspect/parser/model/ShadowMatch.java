...
package org.fitframework.aop.interceptor.aspect.parser.model;
...
public class ShadowMatch {
    ...
    /**
     * 使用指定的切点参数、参数映射和解析结果列表初始化 {@link ShadowMatch} 的新实例。
     *
     ...
     * @param bindingResults 表示解析结果列表的 {@link List}{@code <}{@link ExpressionParser.Result}{@code >}。
     */
