...
package org.fitframework.aop.interceptor.aspect.methodmatcher;

import static org.assertj.core.api.Assertions.assertThat;

import org.fitframework.aop.interceptor.MethodMatcher;
import org.fitframework.aop.interceptor.aspect.interceptor.AspectMethodMatcher;
import org.fitframework.aop.interceptor.aspect.parser.PointcutParameter;
import org.fitframework.aop.interceptor.aspect.parser.support.ExecutionParser;
import org.fitframework.aop.interceptor.aspect.test.TestExecutionAspect;
import org.fitframework.aop.interceptor.aspect.test.TestParam;
...
public class ExecutionMatcherTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "execution(public String org.fitframework.aop.interceptor.aspect.test.TestService1.m1())",
            "execution(* org.fitframework.aop.interceptor.aspect.test.*.m1(..))",
    ...
    @ParameterizedTest
    @CsvSource({
            "execution(public String org.fitframework.aop.interceptor.aspect.test.TestService1.m2(String))",
            "execution(* * org.fitframework.aop.interceptor.aspect.test.TestService1.*(*))",
            "execution(* org.fitframework.aop.interceptor.aspect.test.*.m2(..))",
    ...
    void givenExpressionContainsExecutionWithMultiParamsThenProxyMatches() {
        String[] expressions = {
                "execution(public org.fitframework.aop.interceptor.aspect.test.TestParam"
                        + " org.fitframework.aop.interceptor.aspect.test.TestService1.m5("
                        + "org.fitframework.aop.interceptor.aspect.test.TestParam, " + "java.util.List,"
                        + "int[]," + "java.util.Map))",
                "execution(* * org.fitframework.aop.interceptor.aspect.test.TestService1.*(" + "*, "
