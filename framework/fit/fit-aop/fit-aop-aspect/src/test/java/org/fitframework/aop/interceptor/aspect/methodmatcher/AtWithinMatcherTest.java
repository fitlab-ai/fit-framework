...
import org.fitframework.aop.interceptor.aspect.parser.support.AtWithinParser;
import org.fitframework.aop.interceptor.aspect.parser.support.DefaultPointcutParameter;
import org.fitframework.aop.interceptor.aspect.test.TestAnnotation;
...
public class AtWithinMatcherTest {
    ...
    void givenExpressionContainsAnnotationThenMethodMatchesSuccessfully(String methodName) {
        String exp = "@within(org.fitframework.aop.interceptor.aspect.test.TestAnnotation)";
