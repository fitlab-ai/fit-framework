...
import org.fitframework.aop.interceptor.aspect.parser.support.AtTargetParser;
...
public class AtTargetMatcherTest {
    ...
    void givenParametersFilterMatchThenReturnMatches() {
        String exp = "@target(org.fitframework.aop.interceptor.aspect.test.TestAnnotation)";
        Method method = AtTargetMatcherTest.this.service1M1Method;
