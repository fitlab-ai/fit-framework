...
import org.fitframework.aop.interceptor.aspect.type.support.DefaultJoinPoint;
import org.fitframework.aop.interceptor.aspect.type.support.DefaultSignature;
import org.fitframework.aop.interceptor.support.DefaultMethodMatcherCollection;
    ...
    class TestJoinPoint {
        ...
        void givenJoinPointShouldReturnParameter() {
            ...
            assertThat(joinPointTmp.toString()).isEqualTo(
                    "execution(String org.fitframework.aop.interceptor.aspect.test.TestService1.m2(String))");
            assertThat(joinPointTmp.toLongString()).isEqualTo(
                    "execution(public java.lang.String org.fitframework.aop.interceptor.aspect.test"
