...
import org.fitframework.aop.interceptor.aspect.parser.support.WithinParser;
...
public class WithinMatcherTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "within(org.fitframework.aop.interceptor.aspect.test.TestService1)",
            "within(org.fitframework.aop.interceptor..TestService1)",
            "within(org.fitframework.aop.interceptor..*)",
            "within(org.fitframework.aop.*.aspect.test.*)",
            "within(org.fitframework.aop..aspect.test.*Service1)",
            "within(org.fitframework.aop.interceptor.aspect.test.TestService*)"
    })
