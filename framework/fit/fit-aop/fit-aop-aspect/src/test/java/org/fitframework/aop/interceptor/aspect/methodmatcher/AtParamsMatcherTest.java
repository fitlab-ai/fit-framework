...
import org.fitframework.aop.interceptor.aspect.parser.support.AtParamsParser;
...
public class AtParamsMatcherTest {
    ...
    void givenParametersFilterMatchThenReturnMatches() {
        String exp = "@args(org.fitframework.aop.interceptor.aspect.test.TestAnnotation)";
        Method method = AtParamsMatcherTest.this.service1M6Method;
