...
import org.fitframework.retry.ConditionNotMatchException;
import org.fitframework.retry.RecoverCallable;
import org.fitframework.retry.RetryBackOff;
import org.fitframework.retry.RetryException;
...
public class DefaultRetryExecutor<T> implements RetryExecutor<T> {
    ...
    /**
     * 表示 {@link org.fitframework.retry.RetryExecutor.Builder} 的默认实现。
     *
