...
**位置**: `org.fitframework.http.annotation.RequestAuth`
...
**位置**: `org.fitframework.http.client.proxy.scanner.AnnotationParser`
...
**位置**: `org.fitframework.http.client.proxy.support.applier.StaticAuthApplier`
...
**位置**: `org.fitframework.http.client.proxy.scanner.resolver.RequestAuthResolver`
...
**位置**: `org.fitframework.http.client.proxy.scanner.resolver.AuthFieldMapper`
...
**位置**: `org.fitframework.http.client.proxy.support.setter.AuthorizationDestinationSetter`
...
**位置**: `org.fitframework.http.client.proxy.Authorization`
...
**位置**: `org.fitframework.http.client.proxy.scanner.HttpInvocationHandler`
