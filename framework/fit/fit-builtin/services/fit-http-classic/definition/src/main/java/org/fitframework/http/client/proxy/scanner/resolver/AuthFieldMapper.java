...
import org.fitframework.http.client.proxy.auth.AuthType;
import org.fitframework.http.client.proxy.support.authorization.ApiKeyAuthorization;
import org.fitframework.http.client.proxy.support.authorization.BasicAuthorization;
import org.fitframework.http.client.proxy.support.authorization.BearerAuthorization;
import org.fitframework.util.StringUtils;

/**
 * 鉴权字段映射工具类。
 * <p>用于确定参数级别鉴权应该更新 {@link org.fitframework.http.client.proxy.Authorization}
 * 对象的哪个字段。</p>
 *
 * <p><b>设计背景</b></p>
 ...
 *
 * @author 季聿阶
 * @see org.fitframework.http.client.proxy.Authorization
 * @see org.fitframework.http.client.proxy.support.setter.AuthorizationDestinationSetter
