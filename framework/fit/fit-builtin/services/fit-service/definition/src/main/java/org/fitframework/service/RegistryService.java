...
import org.fitframework.service.entity.Application;
import org.fitframework.service.entity.FitableAddressInstance;
import org.fitframework.service.entity.FitableInfo;
import org.fitframework.service.entity.FitableMeta;
import org.fitframework.service.entity.FitableMetaInstance;
import org.fitframework.service.entity.GenericableInfo;
import org.fitframework.service.entity.Worker;
...
public interface RegistryService {
     ...
     */
    @Genericable(id = "org.fitframework.registry.registry-service.register-fitables")
     ...
     */
    @Genericable(id = "org.fitframework.registry.registry-service.unregister-fitables")
     ...
     */
    @Genericable(id = "org.fitframework.registry.registry-service.query-fitables-addresses")
     ...
     * @return 表示指定服务实现的所有实例信息的 {@link List}{@code <}{@link FitableAddressInstance}{@code >}。
     */
    @Genericable(id = "org.fitframework.registry.registry-service.subscribe-fitables")
     ...
     */
    @Genericable(id = "org.fitframework.registry.registry-service.unsubscribe-fitables")
     ...
     */
    @Genericable(id = "org.fitframework.registry.registry-service.query-running-fitables")
