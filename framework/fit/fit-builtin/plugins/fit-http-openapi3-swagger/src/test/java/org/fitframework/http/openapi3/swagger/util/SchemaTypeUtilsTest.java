...
package org.fitframework.http.openapi3.swagger.util;
...
public class SchemaTypeUtilsTest {
    ...
    class TestGetTypeName {
        ...
        void shouldReturnTypeNameWhenTypeIsGeneric() {
            ...
            assertThat(actual).isEqualTo("org.fitframework.http.openapi3.swagger.util.SchemaTypeUtilsTest$Sample3_of_"
                    + "org.fitframework.http.openapi3.swagger.util.SchemaTypeUtilsTest$Sample1_and_"
                    + "org.fitframework.http.openapi3.swagger.util.SchemaTypeUtilsTest$Sample2");
        }
    }
