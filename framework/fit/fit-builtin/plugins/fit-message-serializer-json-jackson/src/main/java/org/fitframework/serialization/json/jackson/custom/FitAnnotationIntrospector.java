...
import org.fitframework.serialization.annotation.SerializeStrategy;
...
public class FitAnnotationIntrospector extends AnnotationIntrospector {
    ...
    public Version version() {
        return VersionUtil.parseVersion("3.7.0-SNAPSHOT", "org.fitframework.plugin", "fit-message-serializer-json-jackson");
    }
