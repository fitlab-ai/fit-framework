 ...
 * <ol>
 *     <li><b>单接口单方法规范：</b>接口类上存在 {@link org.fitframework.annotation.Genericable}
 *     注解，且接口类中仅有一个方法，该方法的名字为
 *     {@link org.fitframework.util.GenericableUtils#GENERICABLE_METHOD_NAME}。</li>
 *     <li><b>单接口多方法规范：</b>接口类中存在多个方法，每一个服务方法上存在 {@link org.fitframework.annotation.Genericable}
 *     注解。</li>
 * </ol>
 *
 * @author 梁济时
...
public interface BrokerClient {
    /**
     * 获取一个服务的自定义动态路由器。
     * <p>该服务类上必定需要存在 {@link org.fitframework.annotation.Genericable} 注解。</p>
     *
    ...
    /**
     * 获取一个服务的自定义动态路由器。
     * <p>该服务类的方法上必定需要存在 {@link org.fitframework.annotation.Genericable}
