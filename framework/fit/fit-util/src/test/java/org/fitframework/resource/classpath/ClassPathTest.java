...
import org.fitframework.resource.classpath.support.DefaultClassPath;
import org.fitframework.resource.classpath.support.FileClassPathKey;
...
class ClassPathTest {
    ...
    void givenFileShouldReturnClassPath() {
        ...
        Assertions.assertThat(classPath.directory()).isEqualTo(directory);
