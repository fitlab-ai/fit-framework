...
package org.fitframework.jvm.classfile.annotation;

import static org.assertj.core.api.Assertions.assertThat;

import org.fitframework.inspection.Validation;
import org.fitframework.jvm.classfile.AttributeInfo;
import org.fitframework.jvm.classfile.AttributeList;
import org.fitframework.jvm.classfile.ClassFile;
import org.fitframework.jvm.classfile.ConstantPool;
import org.fitframework.jvm.classfile.attribute.RuntimeVisibleAnnotationsAttribute;
...
class AnnotationElementValueTest {
    ...
    void init() throws IOException {
        try (InputStream inputStream = AnnotationListTest.class.getClassLoader()
                .getResourceAsStream("org/fitframework/jvm/test/AttributeTarget.class")) {
            ...
            while (annotations.hasNext()) {
                ...
                if (Objects.equals(typeIndex, "Lorg/fitframework/jvm/test/AssignmentTarget;")) {
    ...
    class TestEnumValue {
        ...
        void givenEnumValueShouldReturnElementTypeValue() {
            ...
            assertThat(value).isEqualTo("Lorg/fitframework/jvm/test/AssignmentTarget$EnumValue;");
        }
    }
    ...
    class TestAnnotationValue {
        private static final String VALUE = "Lorg/fitframework/jvm/test/NestAssignmentTarget;";
