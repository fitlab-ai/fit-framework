...
import org.fitframework.util.support.PropertyKey;
import org.fitframework.util.support.PropertyKeys;
...
public class PropertiesUtils {
     ...
     *     genericables[0].name=org.fitframework.G1
     *     genericables[0].tags[0]=t1
     *     genericables[0].tags[1]=t2
     *     genericables[0].route=a1
     *     genericables[0].fitables[0].id=org.fitframework.F1.f1
     ...
     *             {
     *                 "id": "g1",
     *                 "name": "org.fitframework.G1",
     *                 "tags": ["t1", "t2"],
     *                 "route": "a1",
     *                 "fitables": [
     *                     {
     *                         "id": "org.fitframework.F1.f1",
     *                         "tags": ["f1", "f2"],
     *                         "aliases": ["a1", "a2"]
     *                     }
     *                 ]
