...
import org.fitframework.parameterization.support.DefaultParameterizedStringResolver;
 ...
 * ParameterizedStringResolver#getParameterSuffix() 后缀}，并提供变量 {@code "name"} 的值为 {@code "Tom"}，则：</p>
 * <pre>
