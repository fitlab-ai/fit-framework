...
public final class DynamicInfo extends Constant {
     ...
     * 表示常量的标签。
     */
    public static final U1 TAG = U1.of(17);

    private final U2 bootstrapMethodAttrIndex;
    private final U2 nameAndTypeIndex;

    /**
     * 构造一个新的 {@link DynamicInfo} 实例。
     *
     * @param pool 表示常量池的 {@link ConstantPool}
     * @param in 表示输入流的 {@link InputStream}。
     * @throws IOException 如果读取常量数据时发生 I/O 错误。
     */
    public DynamicInfo(ConstantPool pool, InputStream in) throws IOException {
        super(pool, TAG);
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            DynamicInfo another = (DynamicInfo) obj;
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[] {
                this.pool(), DynamicInfo.class, this.bootstrapMethodAttrIndex, this.nameAndTypeIndex
        });
    }
