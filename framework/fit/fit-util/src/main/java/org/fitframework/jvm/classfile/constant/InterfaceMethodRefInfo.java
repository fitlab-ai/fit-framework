...
package org.fitframework.jvm.classfile.constant;

import org.fitframework.inspection.Validation;
import org.fitframework.jvm.classfile.Constant;
 ...
 * @since 2022-06-07
 */
public final class InterfaceMethodRefInfo extends Constant {
    /**
     * 表示常量的标签。
     */
    public static final U1 TAG = U1.of(11);

    private final U2 classIndex;
    private final U2 nameAndTypeIndex;

    /**
     * 使用所属的常量池及包含常量数据的输入流初始化 {@link InterfaceMethodRefInfo} 类的新实例。
     *
     ...
     */
    public InterfaceMethodRefInfo(ConstantPool pool, InputStream in) throws IOException {
        super(pool, TAG);
    ...
    public boolean equals(Object obj) {
        if (obj == this) {
            ...
            InterfaceMethodRefInfo another = (InterfaceMethodRefInfo) obj;
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[] {
                this.pool(), InterfaceMethodRefInfo.class, this.classIndex, this.nameAndTypeIndex
        });
    }
