...
import org.fitframework.fel.tool.support.MethodToolMetadata;
import org.fitframework.fel.tool.support.SchemaToolMetadata;
...
public interface Tool {
    ...
    interface Info extends ToolInfo {
         ...
         * 获取当前版本工具是否最新的状态。
         *
         * @return 表示当前版本工具是否最新的状态的 {@code boolean}。
         */
        boolean isLatest();
         ...
         * {@link Info} 的构建器。
         */
        interface Builder extends ToolInfo.Builder<Builder> {
            /**
             * 向当前构建器中设置工具的唯一名字。
             *
             ...
             * 向当前构建器中设置当前工具版本是否最新。
             *
             * @param isLatest 表示待设置的当前工具版本是否最新的 {@code boolean}。
             * @return 表示当前构建器的 {@link Builder}。
             */
    ...
    interface Metadata {
         ...
         *
         * @return 表示必须的参数名字列表的 {@link Set}{@code <}{@link String}{@code >}。
         */
