...
import org.fitframework.fel.core.pattern.Parser;
...
import org.fitframework.fel.core.pattern.Store;
import org.fitframework.fel.core.pattern.Synthesizer;
import org.fitframework.fel.core.util.Tip;
import org.fitframework.fel.engine.activities.processors.AiBranchProcessor;
import org.fitframework.fel.engine.activities.processors.AiFlatMap;
...
import org.fitframework.fel.engine.operators.models.FlowModel;
import org.fitframework.fel.engine.operators.patterns.AbstractFlowPattern;
import org.fitframework.fel.engine.operators.patterns.FlowNodeSupportable;
import org.fitframework.fel.engine.operators.patterns.FlowPattern;
import org.fitframework.fel.engine.operators.patterns.FlowSupportable;
import org.fitframework.fel.engine.operators.patterns.SimpleFlowPattern;
import org.fitframework.fel.engine.operators.prompts.PromptTemplate;
...
import org.fitframework.waterflow.domain.flow.Flows;
import org.fitframework.waterflow.domain.states.Start;
import org.fitframework.waterflow.domain.states.State;
...
import org.fitframework.waterflow.domain.utils.Tuple;
...
public class AiStart<O, D, I, RF extends Flow<D>, F extends AiFlow<D, RF>> extends AiActivity<D, RF, F> {
     ...
     * {@link Conversation#bind(String, Object)} 绑定的自定义上下文。
     * @return 表示数据加工节点的 {@link AiState}{@code <}{@link O}{@code , }{@link D}{@code , }{@link O}{@code ,
     * }{@link RF}{@code , }{@link F}{@code >}。
     * @throws IllegalArgumentException 当 {@code processor} 为 {@code null} 时。
     */
     ...
     *
     * @param processor 表示数据处理器的 {@link Operators.Map}{@code <}{@link O}{@code , }{@link R}{@code >}，
     * 捕获了从 {@link Conversation#bind(String, Object)} 绑定的自定义上下文。
     * @param <R> 表示新节点的输出数据类型。
     * @return 表示数据转换节点的 {@link AiState}{@code <}{@link R}{@code , }{@link D}{@code , }{@link O}{@code ,
     * }{@link RF}{@code , }{@link F}{@code >}。
     * @throws IllegalArgumentException 当 {@code processor} 为 {@code null} 时。
