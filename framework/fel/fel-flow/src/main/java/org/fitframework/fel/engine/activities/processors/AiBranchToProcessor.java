...
import org.fitframework.fel.engine.activities.AiState;
 ...
 * @since 2024-04-28
 */
public interface AiBranchToProcessor<D, I, RF extends Flow<D>, F extends AiFlow<D, RF>> {
    /**
     * 提供分支的处理逻辑。
     *
     ...
     */
    void process(AiState<I, D, I, RF, F> node);
}
