...
```
[INFO] [main] [org.fitframework.runtime.aggregated.AggregatedFitRuntime] FIT application started.
[INFO] [netty-http-server-thread-0] [org.fitframework.http.server.netty.NettyHttpClassicServer] Start netty http server successfully. [httpPort=8080]
```
